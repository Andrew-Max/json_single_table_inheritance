...
describe SingleTableInheritable::ClassMasterList do
  ...
  describe 'build_sti_base_class_list' do
    it "creates an accurate list of present abstract sti classes" do
      class_list = SingleTableInheritable::ClassMasterList.sti_base_class_list
  ...
  describe 'build_relations_lookup' do
    it "creates an accurate map of the sti classes in the app and their members and relationships" do
      relation_map = SingleTableInheritable::ClassMasterList.relations_lookup
      expect(relation_map.keys).to eq(SingleTableInheritable::ClassMasterList.sti_base_class_list)
